...
export default function LoginPage() {
  ...
  return (
    <div style={{ minHeight: '100dvh', display: 'flex', position: 'relative', overflow: 'hidden', background: '#0A1628' }}>
      ...
      <div aria-hidden="true" style={{
        ...
        <div style={{
          ...
          background: 'radial-gradient(circle, rgba(45,91,255,.20) 0%, transparent 70%)',
          filter: 'blur(40px)',
        }} />
        ...
        <div style={{
          ...
          background: 'radial-gradient(circle, rgba(26,63,212,.40) 0%, transparent 70%)',
          filter: 'blur(60px)',
        }} />
        ...
        <div style={{
          ...
          background: 'radial-gradient(circle, rgba(91,127,255,.12) 0%, transparent 70%)',
          filter: 'blur(50px)',
        }} />
        {/* Dot grid */}
        <div style={{
        ...
        >
          <div>
            ...
            <div style={{ marginTop: 56 }}>
              <p style={{ fontSize: 11, fontWeight: 700, letterSpacing: '2px', color: '#8BA4FF', textTransform: 'uppercase', marginBottom: 14 }}>
              ...
              <h1 style={{ fontSize: 38, fontWeight: 800, lineHeight: 1.18, letterSpacing: '-0.8px', color: '#FFFFFF', maxWidth: 400, margin: 0 }}>
                Conecta.{' '}
                <span style={{
                  background: 'linear-gradient(90deg, #8BA4FF, #5B7FFF)',
              ...
              <p style={{ marginTop: 18, fontSize: 15, color: 'rgba(180,200,255,.68)', lineHeight: 1.65, maxWidth: 360 }}>
            ...
            <div style={{ marginTop: 52, display: 'flex', gap: 14, flexWrap: 'wrap' }}>
              {[
                ...
                <div key={i} style={{
                  ...
                  <div style={{ fontSize: 22, fontWeight: 800, color: '#8BA4FF', letterSpacing: '-0.5px', lineHeight: 1 }}>
                    {m.value}
                  </div>
                  <div style={{ fontSize: 11, color: 'rgba(160,185,255,.6)', marginTop: 4, fontWeight: 500 }}>
                    {m.label}
                  </div>
                </div>
              ))}
                ...
                <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  <div style={{
                    ...
                    <svg viewBox="0 0 10 10" fill="none" style={{ width: 9, height: 9 }} aria-hidden="true">
                      <path d="M2 5.2l2 2 4-4" stroke="#8BA4FF" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </div>
                  <span style={{ fontSize: 13.5, color: 'rgba(200,215,255,.8)', lineHeight: 1.5 }}>{text}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          {/* Footer */}
          <div>
            <p style={{ fontSize: 11.5, color: 'rgba(130,155,220,.4)' }}>
        ...
        >
          <div style={{ width: '100%', maxWidth: 360 }}>
            ...
            <form onSubmit={handleSubmit} noValidate style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                ...
                <input
                  ...
                  onFocus={e => {
                    ...
                    e.currentTarget.style.boxShadow = '0 0 0 3px rgba(45,91,255,.12)'
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <Link href="/recuperar-senha" style={{ fontSize: 12.5, fontWeight: 600, color: '#2D5BFF', textDecoration: 'none' }}>
                    Esqueci a senha
                  </Link>
                </div>
              ...
              <button
                ...
                style={{
                  ...
                  background: loading ? '#1A3FD4' : 'linear-gradient(135deg, #2D5BFF 0%, #1A3FD4 100%)',
                  color: '#FFFFFF', fontSize: 14.5, fontWeight: 700, letterSpacing: '0.2px',
                  border: 'none', cursor: loading ? 'not-allowed' : 'pointer',
                  display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8,
                  opacity: loading ? 0.8 : 1,
                  boxShadow: loading ? 'none' : '0 4px 18px rgba(45,91,255,.30)',
                  transition: 'opacity .15s, box-shadow .15s',
                }}
                onMouseEnter={e => { if (!loading) { e.currentTarget.style.opacity = '0.9'; e.currentTarget.style.boxShadow = '0 6px 24px rgba(45,91,255,.38)' } }}
                onMouseLeave={e => { e.currentTarget.style.opacity = '1'; e.currentTarget.style.boxShadow = '0 4px 18px rgba(45,91,255,.30)' }}
              >
                {loading && <Spinner />}
            ...
            <p style={{ textAlign: 'center', fontSize: 13, color: '#94A3B8', marginTop: 22 }}>
              Não tem conta?{' '}
              <Link href="/cadastro" style={{ color: '#2D5BFF', fontWeight: 700, textDecoration: 'none' }}>
                Fale com nosso time
              </Link>
            </p>
            ...
            <div style={{ marginTop: 42, paddingTop: 26, borderTop: '1px solid #E8EEF5', display: 'grid', gridTemplateColumns: 'repeat(3, minmax(0, 1fr))', gap: 10 }}>
              {[
                ...
                <div key={label} style={{
                  ...
                  <Icon size={16} aria-hidden="true" style={{ color: '#2D5BFF' }} />
